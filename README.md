...
* More JS practice problems added in `JS_Basics` page. Please keep watching this space. A good place to visit free code camp site for basic assignments in JS basics section.[JS Basics](https://www.freecodecamp.org/map#nested-collapseBasicJavaScript)
